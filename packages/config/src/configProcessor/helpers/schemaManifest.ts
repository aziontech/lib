    ...
    edge_functions: {
      ...
      items: {
        ...
        properties: {
          ...
          initiator_type: {
            type: 'string',
            enum: FUNCTION_INITIATOR_TYPES,
            default: 'edge_application',
            errorMessage: `The 'initiator_type' field must be one of: ${FUNCTION_INITIATOR_TYPES.join(', ')}.`,
          },
        },
