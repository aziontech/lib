  ...
  properties: {
    ...
    behavior: {
      ...
      properties: {
        ...
        runFunction: {
          type: 'string',
          errorMessage: "The 'runFunction' behavior must be the name of a function defined in the 'functions' array",
        },
        setWafRuleset: {
          type: 'object',
          properties: {
...
const azionConfigSchema = {
  ...
  errorMessage: "The function referenced in 'runFunction' must exist in the 'functions' array",
};
