...
export default {
  inject: {
    ...
    // TextEncoder: `${polyfillsPath}/node/globals/util-global.js`,
    // TextDecoder: `${polyfillsPath}/node/globals/util-global.js`,
  },
  alias: {
  ...
  external: ['node:async_hooks', 'node:fs/promises', '@fastly/http-compute-js'],
  polyfill: [
